...
<div align="center">
  <strong>Data Augmentation, Training and Evaluation Web Server</strong>
</div>
<div align="center">
...
This is a two part program (CSAM AI Server and CSAM Train Server) for hollistic approach in collecting, training and presenting the prediction.

CSAM AI Training consist of three pages: CSAM Defects Augmentation, CSAM Model Training and Settings page.

Using React & Python Libraries, a full-stack program was created to assist daily production on defects detection.

Previously required manually judgement by zooming in and out of image window to look for defects on individual chips.
...
3. Clone Repo
   ```sh
   git clone https://github.com/cljiahao/csam_ai_training.git
   ```
...
8. Navigate to Frontend folder in Command Line and Install node modules
   ...
   npm i
   ```
9. Add this line of code into node_modules > react-scripts > config > webpack.config.js
   ```
    modules: ['node_modules', paths.appNodeModules].concat(
        modules.additionalModulePaths || []
      ),
    # Add the following below modules. Line 312
    fallback: {
        fs: false,
        path: false,
        crypto: false
   ...
   ```
10. Close command line and start coding!!! :computer:
...
- [ ] Include comments for each functions, class and modules (backend)
- [ ] Include testing environment
- [ ] Improve settings page computation speed
- [ ] Rework on the dynamic sizing for frontend
